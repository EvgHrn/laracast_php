...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 21 2017 г., 18:17
...
('root', '[{\"db\":\"todo_db\",\"table\":\"todos\"},{\"db\":\"todo_db\",\"table\":\"tasks\"}]');
...
('root', '2017-03-18 18:13:01', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- База данных: `todo_db`
--
CREATE DATABASE IF NOT EXISTS `todo_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `todo_db`;
